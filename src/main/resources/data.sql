...
create table user (id bigint not null auto_increment, age integer, password varchar(255), salary bigint, username varchar(255), email varchar(100),primary key (id)) engine=MyISAM;
...
INSERT INTO role (id, description, name) VALUES (2, 'Employer role', 'ROLE_EMPLOYER');
